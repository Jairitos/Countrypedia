    ...
    <section class="mt-32 container mx-auto h-full px-4 md:px-8">
        <div>
            ...
            <div class="w-full flex flex-col md:flex-row mb-10 md:mb-0">
                <h1
                    class="inline-block w-2/3 text-open-sans text-black-light text-lg font-bold mb-6 uppercase leading-none"
...
@Component
export default class Europe extends Vue {
    selected: string = "";
    ...
    get getEuropeanCountries(): Array<string> {
        ...
        const arrayCountries: Array<any> = this.$store.getters.allEuropeanCountries;
        const arrayOfNames = this.filterNames( arrayCountries.map(item => item.name)) as Array<string>;
        return arrayOfNames;
    }
